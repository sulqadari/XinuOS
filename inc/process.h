...
#define PROCESS_READY   2   // on ready queue
#define PROCESS_RECV    3   // waiting message
#define PROCESS_SLEEP   4   // sleeping
#define PROCESS_SUSPEND 5   // suspended
#define PROCESS_WAIT    6   // semaphore queue
#define PROCESS_RECTIM  7   // receiving with timeout
